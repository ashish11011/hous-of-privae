...
const stages = [
  { label: "Stitching", Icon: ScissorsLineDashed },
      ...
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-10">
          ...
          <p className="mx-auto mt-7 text-sm font-body text-muted-foreground">
            Enter your order details and our team will help you follow your
            piece from atelier to doorstep.
          </p>
        </div>
        ...
        >
          <input
            className="w-full px-4 py-3 bg-background border border-border focus:border-primary outline-none text-sm"
          ...
          {submitted && (
            <p className="text-center text-xs text-muted-foreground">
              We could not verify an order directly here. Please check your
              email/WhatsApp tracking link or contact concierge with this order
              number.
            </p>
          )}
        </form>
          ...
          <div className="flex justify-between gap-2">
            {stages.map(({ label, Icon }, index) => (
              ...
              >
                ...
                />
                <span className="text-[10px] tracking-[0.15em] uppercase text-center leading-snug text-muted-foreground">
                  {label}
                </span>
              </div>
            ))}
